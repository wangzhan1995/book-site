            ...
            <div class="cart">
                ...
                <div class="summary">
                    <p>
                        ...
                        <span>¥{{parseInt(getTotalPrice)}}</span>
                    </p>
                    <p v-if="parseInt(getTotalPrice)>=100">
                        <span style="text-align: right">优惠</span>
                        <span>-¥15.00</span>
                    </p>
                </div>
                <div class="count">
                    <span>合计（不含运费）</span>
                    <span v-if="parseInt(getTotalPrice)>=100">￥{{parseInt(getTotalPrice)-15}}</span>
                    <span v-else-if="parseInt(getTotalPrice)<=100">￥{{parseInt(getTotalPrice)}}</span>
                </div>
            </div>
